        ...
        struct Round_Robin {
            ...
            Round_Robin() {
                ...
                while (Queue.Head != nullptr) {
                    ...
                    // Display Output
                    display(CPU,Queue,time_quantum,Next_Process,Queue.Physical_Memory.Process.Process_Information[current_process_index].Process_Stats.Remaining_Time);
            ...
            static void display(struct CPU &CPU,Ready_Queue &Queue,int Time_Quanta,const string &Next_Process,const int &remian_time) {
