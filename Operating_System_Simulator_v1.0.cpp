...
struct Operating_System {
    ...
    struct Memory_Management {
        ...
        struct Physical_Memory {
            ...
            display(RAM_Size,Page_Size,Frame_Size,Number_of_Frames,Process);
    ...
    struct CPU_Management {
        ...
        struct Ready_Queue {
            ...
            Ready_Queue() {
                ...
                for (int i=0;i<Number_of_Process;i++) {
                    ...
                    node_insertion(Head,Tail,&Physical_Memory.Process.Process_Information[i].Process_Stats.PID);
                }
            }
        };
        ...
        struct  FCFS{
            ...
            // Display Function
            void display(Node *&Curr,const struct CPU &cpu,const string &Next_process,const Ready_Queue &Q) {
                // For Initial State
                if (Curr != nullptr) {
                    cout<<"CURRENT ACTION\n"
                        "------------------------------------------------------------\n"
            ...
            void display(const Memory_Management::Physical_Memory &P1) {
                cout<<"============================================================\n"
                    "==================== PHYSICAL MEMORY ======================\n"
                    "============================================================\n\n"
